...
ADR фиксируют причины архитектурных решений. Исполнимые DTO, formulas, priorities и lifecycle rules остаются в профильных [`engine contracts`](../engine/README.md).
