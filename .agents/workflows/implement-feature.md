...
1. Прочитай `AGENTS.md`, инструкцию назначенной роли, Issue, `.agents/rules/rules.md` и только названные engine contracts.
...
7. Добавь тесты по риску и выполни gate из `.agents/rules/rules.md` (раздел 8).
