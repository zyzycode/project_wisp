...
- при утверждении контрактов `docs/engine/*.md` явно выделяет создание TypeScript-портов в `src/application/ports/` как отдельную обязательную задачу для Project Manager;
