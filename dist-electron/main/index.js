...
function metabolizeNeeds(needs, deltaMs, tone = "neutral") {
	...
	if (hours === 0) return {
		...
		boredom: clampNeed$1(needs.boredom ?? 15)
	};
	...
	return {
		...
		boredom: approach(needs.boredom ?? 15, drift.target.boredom ?? 80, drift.ratePerHour.boredom ?? .15, hours)
	};
}
//#endregion
...
exports.COMPACT_WINDOW_WIDTH = COMPACT_WINDOW_WIDTH;
exports.EXPANDED_WINDOW_HEIGHT = EXPANDED_WINDOW_HEIGHT;
exports.EXPANDED_WINDOW_WIDTH = EXPANDED_WINDOW_WIDTH;
