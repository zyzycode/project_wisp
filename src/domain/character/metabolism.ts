...
const TONE_DRIFTS: Record<SynthesizedEmotionalTone, NeedDrift> = {
  ...
  curious: {
    target: { energy: 70, attention: 52, play: 64, comfort: 20, boredom: 75 },
    ratePerHour: { energy: 0.18, attention: 0.08, play: 0.12, comfort: 0.18, boredom: 0.15 },
  },
  shy: {
    target: { energy: 68, attention: 48, play: 46, comfort: 26, boredom: 65 },
    ratePerHour: { energy: 0.18, attention: 0.05, play: 0.06, comfort: 0.2, boredom: 0.1 },
  },
  sleepy: {
    target: { energy: 82, attention: 44, play: 38, comfort: 12, boredom: 60 },
    ratePerHour: { energy: 0.3, attention: 0.04, play: 0.05, comfort: 0.32, boredom: 0.08 },
  },
  playful: {
    target: { energy: 58, attention: 50, play: 50, comfort: 24, boredom: 85 },
    ratePerHour: { energy: 0.16, attention: 0.09, play: 0.08, comfort: 0.16, boredom: 0.2 },
  },
  affectionate: {
    target: { energy: 66, attention: 38, play: 45, comfort: 16, boredom: 70 },
    ratePerHour: { energy: 0.16, attention: 0.06, play: 0.07, comfort: 0.2, boredom: 0.12 },
  },
  flustered: {
    target: { energy: 60, attention: 42, play: 42, comfort: 34, boredom: 65 },
    ratePerHour: { energy: 0.14, attention: 0.05, play: 0.05, comfort: 0.18, boredom: 0.1 },
  },
};
...
export function metabolizeNeeds(
  ...
  if (hours === 0) {
    return {
      ...
      boredom: clampNeed(needs.boredom ?? 15),
    };
  }
  ...
  return {
    ...
    boredom: approach(needs.boredom ?? 15, drift.target.boredom ?? 80, drift.ratePerHour.boredom ?? 0.15, hours),
  };
}
