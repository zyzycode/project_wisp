...
Общий навигатор — [docs/README.md](docs/README.md). Статусы реализации и последовательность работ — в [ROADMAP.md](ROADMAP.md) и [очереди задач](.agents/tasks/README.md); наличие компонента на схеме не означает, что соответствующая фаза уже завершена.
