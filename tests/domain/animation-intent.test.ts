...
const EXPECTED_MATRIX: Record<BehaviorKind, Record<Tone, ExpectedMapping>> = {
  ...
  sit: {
    shy: { kind: 'sit', expressionHint: 'blush', propHint: 'none' },
    sleepy: { kind: 'sit', expressionHint: 'sleepy', propHint: 'none' },
    playful: { kind: 'sit', expressionHint: 'winking', propHint: 'sparkle' },
    curious: { kind: 'sit', expressionHint: 'curious', propHint: 'question' },
    neutral: { kind: 'sit', expressionHint: 'idle', propHint: 'none' },
    affectionate: { kind: 'sit', expressionHint: 'happy', propHint: 'heart' },
    flustered: { kind: 'sit', expressionHint: 'blush', propHint: 'heart' },
  },
  stand_up: {
    shy: { kind: 'stand_up', expressionHint: 'blush', propHint: 'none' },
    sleepy: { kind: 'stand_up', expressionHint: 'sleepy', propHint: 'none' },
    playful: { kind: 'stand_up', expressionHint: 'happy', propHint: 'sparkle' },
    curious: { kind: 'stand_up', expressionHint: 'curious', propHint: 'question' },
    neutral: { kind: 'stand_up', expressionHint: 'idle', propHint: 'none' },
    affectionate: { kind: 'stand_up', expressionHint: 'happy', propHint: 'heart' },
    flustered: { kind: 'stand_up', expressionHint: 'blush', propHint: 'heart' },
  },
  lie_down: {
    shy: { kind: 'lie_down', expressionHint: 'blush', propHint: 'none' },
    sleepy: { kind: 'lie_down', expressionHint: 'sleepy', propHint: 'none' },
    playful: { kind: 'lie_down', expressionHint: 'winking', propHint: 'sparkle' },
    curious: { kind: 'lie_down', expressionHint: 'curious', propHint: 'question' },
    neutral: { kind: 'lie_down', expressionHint: 'idle', propHint: 'none' },
    affectionate: { kind: 'lie_down', expressionHint: 'happy', propHint: 'heart' },
    flustered: { kind: 'lie_down', expressionHint: 'blush', propHint: 'heart' },
  },
  get_up: {
    shy: { kind: 'get_up', expressionHint: 'blush', propHint: 'none' },
    sleepy: { kind: 'get_up', expressionHint: 'sleepy', propHint: 'none' },
    playful: { kind: 'get_up', expressionHint: 'winking', propHint: 'sparkle' },
    curious: { kind: 'get_up', expressionHint: 'curious', propHint: 'question' },
    neutral: { kind: 'get_up', expressionHint: 'idle', propHint: 'none' },
    affectionate: { kind: 'get_up', expressionHint: 'happy', propHint: 'heart' },
    flustered: { kind: 'get_up', expressionHint: 'blush', propHint: 'heart' },
  },
  run: {
    shy: { kind: 'run', expressionHint: 'blush', propHint: 'none' },
    sleepy: { kind: 'run', expressionHint: 'sleepy', propHint: 'none' },
    playful: { kind: 'run', expressionHint: 'winking', propHint: 'sparkle' },
    curious: { kind: 'run', expressionHint: 'curious', propHint: 'question' },
    neutral: { kind: 'run', expressionHint: 'happy', propHint: 'none' },
    affectionate: { kind: 'run', expressionHint: 'happy', propHint: 'heart' },
    flustered: { kind: 'run', expressionHint: 'blush', propHint: 'heart' },
  },
  jump: {
    shy: { kind: 'jump', expressionHint: 'blush', propHint: 'none' },
    sleepy: { kind: 'jump', expressionHint: 'sleepy', propHint: 'none' },
    playful: { kind: 'jump', expressionHint: 'winking', propHint: 'sparkle' },
    curious: { kind: 'jump', expressionHint: 'curious', propHint: 'question' },
    neutral: { kind: 'jump', expressionHint: 'happy', propHint: 'none' },
    affectionate: { kind: 'jump', expressionHint: 'happy', propHint: 'heart' },
    flustered: { kind: 'jump', expressionHint: 'blush', propHint: 'heart' },
  },
  fall: {
    shy: { kind: 'fall', expressionHint: 'surprised', propHint: 'none' },
    sleepy: { kind: 'fall', expressionHint: 'surprised', propHint: 'none' },
    playful: { kind: 'fall', expressionHint: 'surprised', propHint: 'sparkle' },
    curious: { kind: 'fall', expressionHint: 'surprised', propHint: 'question' },
    neutral: { kind: 'fall', expressionHint: 'surprised', propHint: 'none' },
    affectionate: { kind: 'fall', expressionHint: 'surprised', propHint: 'heart' },
    flustered: { kind: 'fall', expressionHint: 'surprised', propHint: 'heart' },
  },
  crawl: {
    shy: { kind: 'crawl', expressionHint: 'blush', propHint: 'none' },
    sleepy: { kind: 'crawl', expressionHint: 'sleepy', propHint: 'none' },
    playful: { kind: 'crawl', expressionHint: 'winking', propHint: 'sparkle' },
    curious: { kind: 'crawl', expressionHint: 'curious', propHint: 'question' },
    neutral: { kind: 'crawl', expressionHint: 'curious', propHint: 'none' },
    affectionate: { kind: 'crawl', expressionHint: 'happy', propHint: 'heart' },
    flustered: { kind: 'crawl', expressionHint: 'blush', propHint: 'heart' },
  },
};
...
const EXPECTED_POLICY: Record<AnimationIntentKind, {
  ...
  run: { category: 'movement', priority: 'normal' },
